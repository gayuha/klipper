...
class ControlPID:
    ...
    def temperature_update(self, read_time, temp_real, target_temp,
        ...
        logging.info("pid: %f@%.3f -> target=%f temp_diff=%f time_diff=%f \
            deriv=%f err=%f integ=%f co=%f extruder_velocity=%f",
            temp, read_time, target_temp, temp_diff, time_diff, temp_deriv,
            temp_err, temp_integ, extruder_velocity, co)
